...
const reservations = [{
    id: '12345',
    restaurantId: '123',
    userId: '2BLAgBxV6WfUnN8P73YiiqfQOg13', // replace these userIds with your own
    ...
    id: '12346',
    restaurantId: '345',
    userId: '2BLAgBxV6WfUnN8P73YiiqfQOg13',
...
const reviews = [{
    ...
    photoUrls: ['https://storage.googleapis.com/loopnotluck.appspot.com/reviewPhotos/hemingways-review-1.jpeg'],
    text: `
...
const restaurants = [{
    id: '123',
    name: 'Hemingway\'s',
    imageUrl: 'https://storage.googleapis.com/loopnotluck.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
    ...
    id: '345',
    name: 'Ben\'s Burgers',
    imageUrl: 'https://storage.googleapis.com/loopnotluck.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
    ...
    id: '678',
    name: 'Le Mollusc',
    imageUrl: 'https://storage.googleapis.com/loopnotluck.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
